// Type definition for unist-util-visit@1.4.1
// See: https://github.com/syntax-tree/unist-util-visit/blob/2.0.0/types/index.d.ts

declare module 'unist-util-visit' {
  import { Node } from 'unist';
  import { Test } from 'unist-util-is';
  import { Action, ActionTuple, Continue, Exit, Index, Skip } from 'unist-util-visit-parents';
  ...
  declare namespace visit {
     ...
     */
    type Visitor<V extends Node> = (node: V, index: number, parent: Node) => void | Action | Index | ActionTuple;
  }
  ...
  declare const visit: {
     ...
     */
    <V extends Node>(tree: Node, test: Test<V> | Array<Test<any>>, visitor: visit.Visitor<V>, reverse?: boolean): void;
